...
import { idlFactory } from './heirlock.did.js';
export { idlFactory } from './heirlock.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HEIRLOCK;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./heirlock.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the heirlock canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./heirlock.did.js")._SERVICE>}
 */
export const heirlock = createActor(canisterId);
